...
let somaResultado = soma ( 2 , 8)
console.log(somaResultado)
// 2. Concatenação de Strings
// Escreva uma função chamada `concatenaNomes` que recebe dois parâmetros `nome` e `sobrenome`.
// Retorne uma string que concatene `nome` e `sobrenome`, separando-os por um espaço e armazene-a 
//em uma variavel chamada "nomeCompleto". Imprima-a no terminal.

function concatenaNomes(nome, sobrenome) {
let nomeCompleto = nome + sobrenome
return   nomeCompleto
}
console.log(concatenaNomes("Alane", "thewes"))
// 3. Maiúsculas
...
console.log(removeUltimo([1, 2, 3, 4]))
